...
export default function VuMeter({ analyser, audioInitialized, gainNode, init, toggleMute, isMuted, isInitialized }) {
    ...
    return (
        ...
        <div className="vu-meter">
            ...
            <div className="vu-meter-background-shadow-big"></div>
            <div className="vu-meter-background-shadow-up"></div>
            <div className="vu-meter-background-shadow-up-big"></div>
            ...
            <div className="vu-meter-light-2"></div>
                ...
                <button type="button" title="initialize audio" className="initAudio" onClick={() => init()}>
                    <div className="button-border"></div>
                    <div className="button-border-2"></div>
                    <div className="button-border-3"></div>
                    <div className="button-border-4"></div>
                    <div className="button-border-5"></div>
                    <div className="button-border-6"></div>
                    <div className="button-border-7"></div>
                    <div className="button-border-8"></div>
                    <div className="button-border-9"></div>
                    <div className="button-border-10"></div>
                    <div className="button-border-11"></div>
                    <div className="button-border-12"></div>
                    <div className="button-border-13"></div>
                    <div className="button-init-button-label">
                        <svg viewBox="0 0 512 512"><path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V256c0 17.7 14.3 32 32 32s32-14.3 32-32V32zM143.5 120.6c13.6-11.3 15.4-31.5 4.1-45.1s-31.5-15.4-45.1-4.1C49.7 115.4 16 181.8 16 256c0 132.5 107.5 240 240 240s240-107.5 240-240c0-74.2-33.8-140.6-86.6-184.6c-13.6-11.3-33.8-9.4-45.1 4.1s-9.4 33.8 4.1 45.1c38.9 32.3 63.5 81 63.5 135.4c0 97.2-78.8 176-176 176s-176-78.8-176-176c0-54.4 24.7-103.1 63.5-135.4z" /></svg>
                        <p> INIT</p>
                    </div>
                </button>

                <button type="button" title="toggle mute" className={`muteAudio ${isMuted ? 'isMuted' : ''}`} onClick={() => toggleMute()} disabled={!isInitialized} >
                    <div className="button-border"></div>
                    <div className="button-border-2"></div>
                    <div className="button-border-3"></div>
                    <div className="button-border-4"></div>
                    ...
                    <div className="button-init-button-label">
                        {!isMuted && <><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M533.6 32.5C598.5 85.3 640 165.8 640 256s-41.5 170.8-106.4 223.5c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C557.5 398.2 592 331.2 592 256s-34.5-142.2-88.7-186.3c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zM473.1 107c43.2 35.2 70.9 88.9 70.9 149s-27.7 113.8-70.9 149c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C475.3 341.3 496 301.1 496 256s-20.7-85.3-53.2-111.8c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zm-60.5 74.5C434.1 199.1 448 225.9 448 256s-13.9 56.9-35.4 74.5c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C393.1 284.4 400 271 400 256s-6.9-28.4-17.7-37.3c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zM301.1 34.8C312.6 40 320 51.4 320 64V448c0 12.6-7.4 24-18.9 29.2s-25 3.1-34.4-5.3L131.8 352H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h67.8L266.7 40.1c9.4-8.4 22.9-10.4 34.4-5.3z" /></svg>
                            <p>MUTE</p></>}
                        {isMuted && <><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M301.1 34.8C312.6 40 320 51.4 320 64V448c0 12.6-7.4 24-18.9 29.2s-25 3.1-34.4-5.3L131.8 352H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h67.8L266.7 40.1c9.4-8.4 22.9-10.4 34.4-5.3zM425 167l55 55 55-55c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-55 55 55 55c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-55-55-55 55c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l55-55-55-55c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0z" /></svg>
                            <p>UNMUTE</p></>}
